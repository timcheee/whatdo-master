...
public class LocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBackButton = (Button) findViewById(R.id.nextButton);
        ...
        GeoPoint startPoint = new GeoPoint(lat,lang);
...
//play around with these values to get the location on screen in the right place for your applicatio
        ...
        items.add(new OverlayItem("Smeti2", "Veliko smeti", new GeoPoint(lat,lang)));
